    ...
    <div className={cn("flex flex-col gap-2", className)}>
      <div className="flex items-center justify-between gap-2 px-1">
        ...
        <button
          ...
          className="text-[11px] font-semibold text-indigo-600 hover:text-indigo-800 flex items-center gap-1 hover:bg-indigo-50 px-2 py-0.5 rounded-md transition-colors"
            ...
            <div
              ...
              className={cn(
                ...
                isActive 
                  ...
                  : preset.isCustom 
                    ? "bg-indigo-50/70 border-indigo-200 text-indigo-900 hover:bg-indigo-100/80 hover:border-indigo-300"
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 max-w-md w-full p-5 flex flex-col gap-4 animate-in zoom-in-95 duration-150">
            ...
            <form onSubmit={handleCreatePreset} className="flex flex-col gap-3.5">
                  ...
                  {EMOJI_OPTIONS.map(emoji => (
                    <button
                      ...
                      className={cn(
                        ...
                        presetEmoji === emoji 
                          ? "bg-indigo-50 border-indigo-500 scale-110 shadow-2xs ring-1 ring-indigo-500" 
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-xl text-xs font-semibold text-white bg-slate-900 hover:bg-slate-800 transition-colors shadow-2xs"
                >
                  Save Preset
                </button>
              </div>
