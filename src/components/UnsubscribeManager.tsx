          ...
          <div className="flex items-center gap-2 self-end sm:self-center">
            {activeTab === 'active' && !aiAnalysis && subscriptions.length > 0 && (
              <button
                ...
                disabled={analyzing}
                className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-200 rounded-lg text-xs font-medium transition-all shadow-xs disabled:opacity-50"
              >
